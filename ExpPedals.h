...
const byte MAX_PEDALS = 2;// max number of pedals to be used
const byte PEDAL01 = A0;
const byte PEDAL02 = A1;
const byte pedal[MAX_PEDALS] = { PEDAL01, PEDAL02};
const unsigned int pedalValueCalibrationMinimumLevel[] = {     0,      0,   };
const unsigned int pedalValueCalibrationMaximumLevel[] = {  1021,   1021,   };
const byte controllerValueMinimumLevel[]               = {     0,      0,   };
const byte controllerValueMaximumLevel[]               = {   127,    127,   };
const byte pedalCC[]                                   = {    27,      7,   }; //define the CC for each pedal
#endif
